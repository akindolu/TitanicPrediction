...
set.seed(1)
train <- read.csv("E:/Documents/DataScience/Kaggle/TitanicCompetition/input/train.csv", stringsAsFactors=FALSE)
test  <- read.csv("E:/Documents/DataScience/Kaggle/TitanicCompetition/input/test.csv",  stringsAsFactors=FALSE)
